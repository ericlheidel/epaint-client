...
export const ModalRegisterInfo = ({
  modalRegisterInfoMessage,
  handleCloseModal,
}) => {
  return (
    <div
    ...
    >
      ...
      <p className="text-white text-3xl mb-4">{modalRegisterInfoMessage}</p>
...
ModalRegisterInfo.propTypes = {
  ...
  modalRegisterInfoMessage: PropTypes.string.isRequired,
}
